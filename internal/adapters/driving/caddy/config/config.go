...
import (
	...
	"github.com/philiph/caddy-saml-disco/internal/adapters/driving/caddy/attributes"
...
type EntitlementHeaderMapping = attributes.EntitlementHeaderMapping
...
// Exported so parent package wrappers can re-use it.
